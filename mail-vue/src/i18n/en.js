const en = {
    ...
    filterRulesDesc: 'Auto-classify incoming mail by sender, subject, etc.',
    filterEmpty: 'No filter rules yet',
    newFilter: 'New rule',
    editFilter: 'Edit rule',
    filterName: 'Name',
    filterField: 'Field',
    filterFieldFrom: 'Sender',
    filterFieldTo: 'Recipient',
    ...
    filterDeleteConfirm: 'Delete this rule?',
    signatures: 'Signatures',
    signaturesDesc: 'HTML signatures auto-appended when composing',
    signatureEmpty: 'No signatures yet',
    newSignature: 'New signature',
    editSignature: 'Edit signature',
    signatureName: 'Name',
    signatureContent: 'Content (HTML)',
    signatureDefault: 'Default',
    signatureSetDefault: 'Set as default',
    signatureCompany: 'Company',
    companySignatures: 'Company signatures',
    newCompanySignature: 'New company signature',
    signatureNone: 'None',
    signaturePicker: 'Signature',
    signatureDeleteConfirm: 'Delete this signature?',
    signature: 'Signature',
    company: 'Enterprise',
    default: 'Default',
    createFilter: 'Create rule for this sender',
