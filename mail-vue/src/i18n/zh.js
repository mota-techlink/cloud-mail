const zh = {
    ...
    archiveConfirmMsg: '确认归档所选邮件？',
    unarchiveConfirmMsg: '确认取消归档？',
    labels: '标签',
    newLabel: '新建标签',
    editLabel: '编辑标签',
    deleteLabel: '删除标签',
    ...
    addLabel: '添加标签',
    labelEmpty: '暂无标签',
    labelDeleteConfirmMsg: '删除标签将解除全部关联，确认？',
    labelNotExist: '标签不存在',
    labelNameRequired: '请输入标签名称',
    labelParent: '父标签',
    labelParentNone: '无（根标签）',
    labelAttachTitle: '应用标签',
    labelAttachSuccess: '标签已应用',
    labelAttach: '打标签',
    manageLabels: '管理标签',
    filterRules: '过滤规则',
    filterRulesDesc: '根据发件人、主题等自动归类来信',
    filterEmpty: '暂无规则',
    newFilter: '新建规则',
    editFilter: '编辑规则',
    filterName: '名称',
    ...
    filterFieldFrom: '发件人',
    filterFieldTo: '收件人',
    filterFieldSubject: '主题',
    filterFieldContent: '正文',
    filterOperator: '匹配方式',
    filterOpContains: '包含',
    filterOpEquals: '等于',
    filterOpStartsWith: '以…开头',
    filterOpEndsWith: '以…结尾',
    filterOpRegex: '正则匹配',
    filterValue: '关键词',
    filterAction: '动作',
    filterActionLabel: '打标签',
    filterActionArchive: '归档',
    filterLabels: '标签',
    filterEnabled: '启用',
    filterDeleteConfirm: '确认删除该规则？',
    signatures: '签名',
    signaturesDesc: '撰写邮件时自动追加 HTML 签名',
    signatureEmpty: '暂无签名',
    newSignature: '新建签名',
    editSignature: '编辑签名',
    signatureName: '名称',
    signatureContent: '内容（HTML）',
    signatureDefault: '默认',
    signatureSetDefault: '设为默认',
    signatureCompany: '企业',
    companySignatures: '企业签名',
    newCompanySignature: '新建企业签名',
    signatureNone: '无',
    signaturePicker: '签名',
    signatureDeleteConfirm: '确认删除该签名？',
    signature: '签名',
    company: '企业',
    default: '默认',
    createFilter: '为此发件人创建过滤规则',
    createRule: '创建规则'
}
export default zh
